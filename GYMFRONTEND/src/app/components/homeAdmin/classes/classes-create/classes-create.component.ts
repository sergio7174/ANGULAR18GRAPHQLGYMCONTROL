...
/*** call Function to verify if class exist */  
...
ClassVerifyMutation(){
  //alert("Estoy en classes - create component - line 165 - ClassVerifygMutation.. " );
  this.apollo.mutate({
         ...
         if (this.classVerified == null){
            ...
            // alert("Estoy en classes-create component - line 180 - ClassVerifyMutation - this.classVerified == null: Go to create image ..... ");
...
/*alert("Estoy en classes - create component - line 191 - ClassSavingMutation - classImage:  " + classImage);
alert("Estoy en classes - create component - line 192 - ClassSavingMutation - key_benefits:  " + this.classForm.get('key_benefits')?.value);
alert("Estoy en classes - create component - line 193 - ClassSavingMutation - expert_trainer:  " + this.classForm.get('expert_trainer')?.value,);*/
...
get expert_trainer () { return this.classForm.controls['expert_trainer'];}
