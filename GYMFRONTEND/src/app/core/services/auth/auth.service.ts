...
export class AuthService {
  ...
  constructor(private readonly http: HttpClient,
    ...
    login(credentials: LoginPostData) {
      ...
      //alert ("Estoy en registerUser - authService - line 41 - {this.myAppUrl}${this.myApiUrl}:  "+`${this.myAppUrl}${this.myApiUrl}login`);
      return this.http.post(`${this.myAppUrl}${this.myApiUrl}api/auth/login`, credentials)
   }
  ...
  registerUser(postData: User) {
   ...
   uploadUserImage(postData: any) {
    alert ("Estoy en uploadUserImage - authService - line 139");
    /*alert ("Estoy en registerUser - authService - line 153 - {this.myAppUrl}${this.myApiUrl}:  "+`${this.myAppUrl}${this.myApiUrl}`);*/
    return this.http.post(`${this.myAppUrl}${this.myApiUrl}upload-image`, postData);
 }

 getAllAdmin(){
  
  //alert ("Estoy en registerUser - authService - line 152");
  //alert ("Estoy en registerUser - authService - line 145 - ${this.myAppUrl}${this.myApiUrl}/getalladmin: " + `${this.myAppUrl}${this.myApiUrl}api/auth/getalladmin`);

  return this.http.get(`${this.myAppUrl}${this.myApiUrl}api/auth/getalladmin`)
 }
