...
alert ('Estoy en classes service -line 43 - '+`${this.myAppUrl}${this.myApiUrl}/createClass`)
...
// function to upload an image to backend server
   uploadClassImage(postData: any) {
    alert ("Estoy en uploadClassImage - class.Service - line 77");
    alert ("Estoy en uploadClassImage - class.Service - line 78 - {this.myAppUrl}${this.myApiUrl}upload-image:  "+`${this.myAppUrl}/upload-image`);
